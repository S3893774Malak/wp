      ...
      <div class="container1">
        <form action="" method="post">
          ...
          <div class="row">
            ...
            <div class="col-75">
              <input type="text" name="user[name]" pattern="([a-zA-Z\s']){2,}" value="<?php echo $booking_info_out['user']['name'];?>" required placeholder="Enter Full Name" />
            </div>
          </div>
          <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="email" name="user[email]" required value="<?php echo $booking_info_out['user']['email'];?>" placeholder="Enter Email" />
            </div>
          </div>
          <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input type="text" name="user[mobile]" value="<?php echo $booking_info_out['user']['mobile']; ?>" pattern="^(?:\+?(61))? ?(?:\((?=.*\)))?(0?[2-57-8])\)? ?(\d\d(?:[- ](?=\d{3})|(?!\d\d[- ]?\d[- ]))\d\d[- ]?\d[- ]?\d{3})$" placeholder="(02) 1234 5678" required />
            </div>
          </div>
          <br>
          <div class="row">
